...
function checkUrlGeneration() {
    ...
    const fullUrl = `https://ec95feb2b722.ngrok-free.app/liff/records?syncTasks=${encodedTasks}`;
...
function checkLiffRouting() {
    ...
    console.log('   https://ec95feb2b722.ngrok-free.app/liff/records');
...
function checkSyncLogic() {
    ...
    // 模擬 LIFF 頁面的同步檢查邏輯
    const mockUrl = 'https://ec95feb2b722.ngrok-free.app/liff/records?syncTasks=%5B%7B%22id%22%3A1%7D%5D';
